        ...
        <div class="flex-1 ml-72 mt-20 p-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Profil Saya</span>
                </div>
                </li>
            </ol>
            </nav>
            ...
            <div class="mt-8 bg-white p-4 rounded-lg">                
                <form>
                    ...
                    <button type="submit" class="text-white bg-[#1D1242] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
                </form>
            </div>
        </div>
    </div>
